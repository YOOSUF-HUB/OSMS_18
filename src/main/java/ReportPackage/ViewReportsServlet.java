...
// view all the list for the report generated
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (reportList != null) {
            ...
            request.getRequestDispatcher("ReportManagement/ReportDashboard.jsp").forward(request, response);
        } else {
            response.sendRedirect("error.jsp?message=Failed to retrieve reports");
        }
    }
}