...
<body>
	<div class="container-fluid">
		<div class="row">
				...
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link active" href="#">
								<i class="fas fa-tachometer-alt"></i> TechNest <span
						...
						<li class="nav-item">
							...
							<div class="dropdown-container">
								<a href="StockManagement/create_stock.jsp"><i
									class="fas fa-plus"></i> Add New Stock</a> <a
									href="StockManagement/view_stock.jsp"><i
									class="fas fa-list"></i> View Stock</a> <a
									href="StockManagement/update_stock.jsp"><i
									class="fas fa-edit"></i> Update Stock</a> <a
									href="StockManagement/delete_stock.jsp"><i
									class="fas fa-trash"></i> Delete Stock</a> <a
									href="StockManagement/add_supplier.jsp"><i
									class="fas fa-plus"></i> Add New Supplier</a>
							</div>
						</li>
						...
						<li class="nav-item">
							...
							<div class="dropdown-container">
								<a href="create_order.jsp"><i class="fas fa-plus"></i>
									Create New Order</a> <a href="view_orders.jsp"><i
									class="fas fa-list"></i> View Orders</a> <a href="update_order.jsp"><i
									class="fas fa-edit"></i> Update Order</a> <a
									href="delete_order.jsp"><i class="fas fa-ban"></i> Cancel
									Order</a>
							</div>
						</li>
			...
			<main role="main"
				class="col-md-9 ml-sm-auto col-lg-10 px-md-4 content">
				<div
